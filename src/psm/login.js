...
export default async (app, req, res) => {
    ...
    const [lead, err] = await app.repository.findOne("LeadsFromPSM", { email, type: "comprou" })
    ...
    app.kommo.moveLeadToStatus(lead.lead_id, 97219640)
    res.json({ redirect_url: "https://meet.google.com/bqy-foxa-uqk" })
};